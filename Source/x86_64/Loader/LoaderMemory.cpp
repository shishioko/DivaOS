...
namespace DivaOS {
    namespace Loader{
        namespace LoaderMemory{
            extern void* Start asm("DivaOS.Loader.LoaderMemory.Start");
            extern void* Offset asm("DivaOS.Loader.LoaderMemory.Offset");
            extern void* End asm("DivaOS.Loader.LoaderMemory.End");
